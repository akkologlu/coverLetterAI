...
function Loading() {
  return (
    <main>
      ...
      <div class="message">
        <p class="message__line">Building the future...</p>
        <p class="message__line">Analyzing the code matrix...</p>
        <p class="message__line">Crafting intelligence one line at a time...</p>
        <p class="message__line">
          Navigating through the algorithmic galaxy...
        </p>
        <p class="message__line">Connecting the dots of innovation...</p>
        <p class="message__line">Optimizing for success...</p>
        <p class="message__line">
          May take longer than a space-time paradox...
        </p>
        <p class="message__line">Finalizing the masterpiece...</p>
      </div>
    </main>
  );
}
